...
<div class="container">
        <form class="form" id="createAccount" method="POST" action="action.php">
            ...
            <div class="form_input-group">
                <input type="text" id="signupUsername" class="form_input" autofocus placeholder="full name">
            ...
            <div class="form_input-group">
                <input type="text" id="signupUsername" class="form_input" autofocus placeholder="choose a username">
                <div class="form_input-error-message"></div>
            </div>
            <div class="form_input-group">
                <input type="password" class="form_input" autofocus placeholder="create Password">
                <div class="form_input-error-message"></div>
            </div>
            <div class="form_input-group">
